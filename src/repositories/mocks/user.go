...
func (m *MockUser) Create(email, password string) (*models.User, error) {
...
func (mr *MockUserMockRecorder) Create(email, password interface{}) *gomock.Call {
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Create", reflect.TypeOf((*MockUser)(nil).Create), email, password)
}
